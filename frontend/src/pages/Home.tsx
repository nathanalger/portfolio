      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <List>
              <ListItem>
                Contributed to the design and development of Runway, a businessl
                relationship management tool, by helping set realistic
                milestones and preparing for a successful product launch.
              </ListItem>
              <ListItem>
              ...
              <ListItem>
                Assisted in maintaining infrastructure for the application in
                both development and production environments, ensuring high
                uptimes and quick fixes for users.
              </ListItem>
            </List>
          </Box>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <List>
              ...
              <ListItem>
                ...
                multiple computers accurately, quote repair costs, and finish
                the repairs all within a timely manner.
              </ListItem>
            </List>
          </Box>
        </CardContent>
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Box sx={{ mb: 3 }}>
            ...
            <List>
              <ListItem>
                Collaborate on the development of high-powered rocket avionics
                by defining system requirements, evaluating design constraints,
                and outlining hardware integration and testing.
              </ListItem>
              <ListItem>
                Develop embedded systems in C++ using STM32-family
                microcontrollers alongside STM libraries to measure
                environmental factors with sensors and collect, process, and
                interpret real-time flight data.
              </ListItem>
              <ListItem>
                Research and evaluate microcontroller and sensor solutions for
                avionics applications, contributing to the design of reliable
                and efficient data acquisition and event management.
              </ListItem>
            </List>
          </Box>
          ...
          <Box>
            ...
            <List>
              <ListItem>
                Met with seniors in the local community patience and clear
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          ...
          <Grid container spacing={2}>
            <Grid xs={12} sm={6}>
              <Typography level="h3">
                Delivery Driver, Hungry Howie's
              </Typography>
